<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('css/module-17-css.css') }}" />
                        ...
                        <li>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="product">
                                    <a href="#"></a>
                                    <div class="productimg">
                                        <img src="../img/breakfast-2-300x233.jpg" alt=""/>
                                    </div>
                                    <div class="addtocart">
                                        <a href="#">Add to Cart</a>
                                    </div>
                        ...
                        <li>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="product">
                                    <a href="#"></a>
                                    <div class="productimg">
                                        <img src="../img/salad-6-300x233.jpg" alt=""/>
                                    </div>
                                    <div class="addtocart">
                                        <a href="#">Add to Cart</a>
                                    </div>
                        ...
                        <li>
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="product">
                                    <a href="#"></a>
                                    <div class="productimg">
                                        <img src="../img/desserts-6-300x233.jpg" alt=""/>
                                    </div>
                                    <div class="addtocart">
                                        <a href="#">Add to Cart</a>
                                    </div>
